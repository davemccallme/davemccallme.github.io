...
data = [
    ...
    {"id": "Payments (PaybyPhone)", "parent": "Call Center - IVR", "value": 4474000},
    {"id": "Billing", "parent": "Call Center - IVR", "value": 1241000},
...
fig = go.Figure(go.Sunburst(
    ...
    hovertext=[item["id"] for item in data],
    hoverinfo='text',
    name="",
    marker=dict(colors=["#0D0887", "#46039F", "#7201A8", "#9C179E", "#BD3786", "#D8576B", "#ED7953", "#FB9F3A", "#FDB366", "#FEE0A2", "#F0F921"]),
